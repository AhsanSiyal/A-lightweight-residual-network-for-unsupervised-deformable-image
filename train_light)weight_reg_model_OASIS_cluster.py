...
from arch.case4_bspl import ResUnet as ResNet
...
def main():
    ...
    save_dir = 'OASIScaseBSPL_30_1500_ncc_{}_dsc{}_diffusion_{}/'.format(weights[0], weights[1], weights[2])
    ...
    epoch_start = 0
    max_epoch = 1500 #max traning epoch
    ...
    train_set = datasets_OASIS.OASISBrainDataset(glob.glob(train_dir + '*.pkl'), transforms=train_composed)
    val_set = datasets_OASIS.OASISBrainInferDataset(glob.glob(val_dir + '*.pkl'), transforms=val_composed)
